            ...
            <div key={category}>
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-1 rounded-full border border-[var(--color-border)]/25 text-xs md:text-sm transition-colors duration-200 cursor-default hover:bg-[#F97316] hover:text-white hover:border-[#F97316]"
                  >
                    {skill}
                  </span>
                ))}
